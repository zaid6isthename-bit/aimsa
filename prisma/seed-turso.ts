...
async function seedAll() {
  ...
  // Team members — full bios and contributions
  const teamMembers = [
    { name: 'Saniya Pawar', slug: 'saniya-pawar', role: 'President', category: 'Leadership', year: 'Session 2026-27', photoUrl: '/team/saniya-pawar.jpg', bio: 'President of the AIMSA council. Leads the student association of the AI & ML department with vision and keeps the community united and driven throughout the session.', contributions: JSON.stringify(['Chairs the AIMSA executive council', 'Represents the AI & ML department community', 'Guides the annual event roadmap']), highlightTag: 'PRESIDENT', displayOrder: 1 },
    { name: 'Ved Ringne', slug: 'ved-ringne', role: 'President', category: 'Leadership', year: 'Session 2026-27', photoUrl: '/team/ved-ringne.jpg', bio: 'President of the AIMSA council alongside the elected leadership team. Brings energy and direction to department initiatives, events, and student programs.', contributions: JSON.stringify(['Co-leads the AIMSA executive council', 'Drives department-wide events and fests', 'Supports student-led initiatives']), highlightTag: 'PRESIDENT', displayOrder: 2 },
    { name: 'Shrushtee Ghule', slug: 'shrushtee-ghule', role: 'Vice President', category: 'Leadership', year: 'Session 2026-27', photoUrl: '/team/shrushtee-ghule.jpg', bio: 'Vice President of AIMSA. Works closely with the council to coordinate planning, delegate responsibilities across the committee, and keep every wing aligned.', contributions: JSON.stringify(['Coordinates cross-committee planning', 'Deputizes the presidency on council matters', 'Strengthens student outreach']), highlightTag: 'VICE PRESIDENT', displayOrder: 3 },
    { name: 'Vivek Singh', slug: 'vivek-singh', role: 'Vice President', category: 'Leadership', year: 'Session 2026-27', photoUrl: '/team/vivek-singh.jpg', bio: 'Vice President of AIMSA. Supports the presidents in council operations and helps bridge the gap between departments, students, and event execution teams.', contributions: JSON.stringify(['Supports council decision-making', 'Assists major event operations', 'Mentors junior committee members']), highlightTag: 'VICE PRESIDENT', displayOrder: 4 },
    { name: 'Haresh Chavan', slug: 'haresh-chavan', role: 'Treasurer', category: 'Leadership', year: 'Session 2026-27', photoUrl: '/team/haresh-chavan.jpg', bio: 'Treasurer of AIMSA. Handles the association finances, budgets every event and fest, and keeps the money flows transparent and accountable to the council.', contributions: JSON.stringify(['Manages the AIMSA event budgets', 'Oversees sponsorships and resource funds', 'Maintains transparent financial records']), highlightTag: 'TREASURER', displayOrder: 5 },
    { name: 'Janhavi Chopkar', slug: 'janhavi-chopkar', role: 'Treasurer', category: 'Leadership', year: 'Session 2026-27', photoUrl: '/team/janhavi-chopkar.jpg', bio: 'Treasurer of AIMSA. Tracks expenses, coordinates with sponsors and vendors, and ensures every rupee allocated to events is used efficiently.', contributions: JSON.stringify(['Processes council and event expenses', 'Coordinates with vendors and partners', 'Reports finances to the council']), highlightTag: 'TREASURER', displayOrder: 6 },
    { name: 'Tanisha Pandey', slug: 'tanisha-pandey', role: 'Technical Secretary', category: 'Core Team', year: 'Session 2026-27', photoUrl: '/team/tanisha-pandey.jpg', bio: 'Technical Secretary of AIMSA. Drives the technical wing — workshops, hackathons, guest talks, and everything code-related in the AI & ML department.', contributions: JSON.stringify(['Plans technical workshops and hackathons', 'Coordinates tech panels and speakers', 'Grows the coding and research community']), highlightTag: 'TECHNICAL SECRETARY', displayOrder: 7 },
    { name: 'Rajkrishna Yadav', slug: 'rajkrishna-yadav', role: 'Co-Technical Secretary', category: 'Core Team', year: 'Session 2026-27', photoUrl: '/team/rajkrishna-yadav.jpg', bio: 'Co-Technical Secretary of AIMSA. Supports the technical wing in organizing hackathons, mentor sessions, and hands-on build events for the department.', contributions: JSON.stringify(['Assists hackathon and workshop logistics', 'Supports technical mentor sessions', 'Helps run the open-source community']), highlightTag: 'CO-TECHNICAL SECRETARY', displayOrder: 8 },
    { name: 'Seema Karki', slug: 'seema-karki', role: 'Event Head', category: 'Core Team', year: 'Session 2026-27', photoUrl: '/team/seema-karki.jpg', bio: 'Event Head of AIMSA. Plans and runs the department events calendar — from technical fests to informal community gatherings across the AI & ML department.', contributions: JSON.stringify(['Manages the department event calendar', 'Leads event execution teams', 'Coordinates venues and scheduling']), highlightTag: 'EVENT HEAD', displayOrder: 9 },
    { name: 'Sahil Gouda', slug: 'sahil-gouda', role: 'Event Head', category: 'Core Team', year: 'Session 2026-27', photoUrl: '/team/sahil-gouda-event.jpg', bio: 'Event Head of AIMSA. Owns the end-to-end delivery of department events, from idea and logistics to on-ground execution with the volunteer crew.', contributions: JSON.stringify(['Delivers major department events', 'Coordinates volunteer teams', 'Handles on-ground event operations']), highlightTag: 'EVENT HEAD', displayOrder: 10 },
    { name: 'Prasad Shetty', slug: 'prasad-shetty', role: 'Cultural Head', category: 'Core Team', year: 'Session 2026-27', photoUrl: '/team/prasad-shetty.jpg', bio: 'Cultural Head of AIMSA. Curates the cultural calendar — music nights, drama, and creative showcases that give the department its celebratory spirit.', contributions: JSON.stringify(['Curates cultural nights and showcases', 'Organizes music and performing arts events', 'Builds the cultural crew']), highlightTag: 'CULTURAL HEAD', displayOrder: 11 },
    { name: 'Aneesh Chaurasia', slug: 'aneesh-chaurasia', role: 'Cultural Head', category: 'Core Team', year: 'Session 2026-27', photoUrl: '/team/aneesh-chaurasia.jpg', bio: 'Cultural Head of AIMSA. Co-leads the cultural wing, producing stage events and creative showcases for the AI & ML department community.', contributions: JSON.stringify(['Co-produces cultural stage events', 'Organizes creative showcases', 'Directs cultural crew volunteers']), highlightTag: 'CULTURAL HEAD', displayOrder: 12 },
    { name: 'Swarangi Parab', slug: 'swarangi-parab', role: 'Creative Head', category: 'Department Leads', year: 'Session 2026-27', photoUrl: '/team/swarangi-parab.jpg', bio: 'Creative Head of AIMSA. Shapes the visual identity of the association — posters, branding, and social media creatives for every department event.', contributions: JSON.stringify(['Designs event posters and branding', 'Owns the AIMSA visual identity', 'Directs social media creatives']), highlightTag: 'CREATIVE HEAD', displayOrder: 13 },
    { name: 'Vinay Kanojia', slug: 'vinay-kanojia', role: 'Photography & Magazine Head', category: 'Department Leads', year: 'Session 2026-27', photoUrl: '/team/vinay-kanojia.jpg', bio: 'Photography & Magazine Head of AIMSA. Captures the department in action and curates the association magazine, documenting student life and events.', contributions: JSON.stringify(['Covers department events on camera', 'Curates the AIMSA magazine', 'Builds the media archive']), highlightTag: 'PHOTOGRAPHY & MAGAZINE HEAD', displayOrder: 14 },
    { name: 'Om Shukla', slug: 'om-shukla', role: 'Photography & Magazine Head', category: 'Department Leads', year: 'Session 2026-27', photoUrl: '/team/om-shukla.jpg', bio: 'Photography & Magazine Head of AIMSA. Co-leads the media wing, shooting event highlights and compiling the stories that make up the association journal.', contributions: JSON.stringify(['Photographs key department moments', 'Supports the magazine production', 'Maintains the photo and video archive']), highlightTag: 'PHOTOGRAPHY & MAGAZINE HEAD', displayOrder: 15 },
    { name: 'Aditya Pandey', slug: 'aditya-pandey', role: 'Publicity Head', category: 'Department Leads', year: 'Session 2026-27', photoUrl: '/team/aditya-pandey.jpg', bio: 'Publicity Head of AIMSA. Spreads the word — managing announcements, social reach, and student engagement for every department activity.', contributions: JSON.stringify(['Runs event publicity campaigns', 'Manages social media presence', 'Grows student event engagement']), highlightTag: 'PUBLICITY HEAD', displayOrder: 16 },
    { name: 'Aayush Pandey', slug: 'aayush-pandey', role: 'Sports Head', category: 'Department Leads', year: 'Session 2026-27', photoUrl: '/team/aayush-pandey.jpg', bio: 'Sports Head of AIMSA. Organizes the inter-department tournaments and league fixtures that bring the athletic spirit of the AIMSA community alive.', contributions: JSON.stringify(['Organizes sports tournaments and leagues', 'Coordinates department teams and fixtures', 'Manages sports event logistics']), highlightTag: 'SPORTS HEAD', displayOrder: 17 },
    { name: 'Soham Patil', slug: 'soham-patil', role: 'Sports Head', category: 'Department Leads', year: 'Session 2026-27', photoUrl: '/team/soham-patil.jpg', bio: 'Sports Head of AIMSA. Co-leads the sports wing, organizing matches, training schedules, and the competitive calendar for the department.', contributions: JSON.stringify(['Co-leads the sports wing', 'Organizes inter-department fixtures', 'Supports athlete teams and practice']), highlightTag: 'SPORTS HEAD', displayOrder: 18 },
    { name: 'Pranav Badgujar', slug: 'pranav-badgujar', role: 'Sports Event Head', category: 'Department Leads', year: 'Session 2026-27', photoUrl: '/team/pranav-badgujar.jpg', bio: 'Sports Event Head of AIMSA. Leads ground execution of sports events — bookings, referees, scoring, and crowd coordination during tournaments.', contributions: JSON.stringify(['Runs on-ground sports event execution', 'Coordinates venues and equipment', 'Manages scoring and fixtures']), highlightTag: 'SPORTS EVENT HEAD', displayOrder: 19 },
    { name: 'Anannya Bangera', slug: 'anannya-bangera', role: 'Sports Event Head', category: 'Department Leads', year: 'Session 2026-27', photoUrl: '/team/anannya-bangera.jpg', bio: 'Sports Event Head of AIMSA. Delivers the sports day operations — from event scheduling to making sure every match runs smoothly on the field.', contributions: JSON.stringify(['Coordinates sports day operations', 'Arranges teams and match schedules', 'Manages event-day volunteer crews']), highlightTag: 'SPORTS EVENT HEAD', displayOrder: 20 },
    { name: 'Adi Shenoy', slug: 'adi-shenoy', role: 'Team Member', category: 'Executive Committee', year: 'Session 2026-27', photoUrl: '/team/adi-shenoy.jpg', bio: 'Executive committee member of AIMSA. Contributes to event execution and keeps the department community involved throughout the session.', contributions: JSON.stringify(['Supports event execution teams', 'Helps on department fest days']), highlightTag: 'TEAM MEMBER', displayOrder: 21 },
    { name: 'Shreya Yadav', slug: 'shreya-yadav', role: 'Team Member', category: 'Executive Committee', year: 'Session 2026-27', photoUrl: '/team/shreya-yadav.jpg', bio: 'Executive committee member of AIMSA. Brings enthusiasm to community events and supports the committee across the department calendar.', contributions: JSON.stringify(['Supports community events', 'Assists council teams and volunteers']), highlightTag: 'TEAM MEMBER', displayOrder: 22 },
    { name: 'Tanushree Lokare', slug: 'tanushree-lokare', role: 'Team Member', category: 'Executive Committee', year: 'Session 2026-27', photoUrl: '/team/tanushree-lokare.jpg', bio: 'Executive committee member of AIMSA. Lends a hand across technical and cultural events and helps grow the AI & ML department community.', contributions: JSON.stringify(['Assists technical and cultural events', 'Supports student engagement drives']), highlightTag: 'TEAM MEMBER', displayOrder: 23 },
    { name: 'Srushti Shinde', slug: 'srushti-shinde', role: 'Team Member', category: 'Executive Committee', year: 'Session 2026-27', photoUrl: '/team/srushti-shinde.jpg', bio: 'Executive committee member of AIMSA. Helps run departmental activities and makes sure no student feels left out of the AIMSA community.', contributions: JSON.stringify(['Supports departmental activities', 'Helps with student outreach']), highlightTag: 'TEAM MEMBER', displayOrder: 24 },
    { name: 'Shreya Tripathi', slug: 'shreya-tripathi', role: 'Team Member', category: 'Executive Committee', year: 'Session 2026-27', photoUrl: '/team/shreya-tripathi.jpg', bio: 'Executive committee member of AIMSA. Contributes to event planning and supports the committee crew during department fests and gatherings.', contributions: JSON.stringify(['Contributes to event planning', 'Supports fest-day execution']), highlightTag: 'TEAM MEMBER', displayOrder: 25 },
    { name: 'Parnika Walunj', slug: 'parnika-walunj', role: 'Team Member', category: 'Executive Committee', year: 'Session 2026-27', photoUrl: '/team/parnika-walunj.jpg', bio: 'Executive committee member of AIMSA. Brings dedication to the volunteer teams and helps keep department events and initiatives running smoothly.', contributions: JSON.stringify(['Joins volunteer execution teams', 'Supports committee initiatives']), highlightTag: 'TEAM MEMBER', displayOrder: 26 },
    { name: 'Soham Mahajan', slug: 'soham-mahajan', role: 'Team Member', category: 'Executive Committee', year: 'Session 2026-27', photoUrl: '/team/soham-mahajan.jpg', bio: 'Executive committee member of AIMSA. Helps with the behind-the-scenes work that makes department events and gatherings feel effortless.', contributions: JSON.stringify(['Supports behind-the-scenes operations', 'Assists at department events']), highlightTag: 'TEAM MEMBER', displayOrder: 27 },
    { name: 'Zaid Mohd', slug: 'zaid-mohd', role: 'Team Member', category: 'Executive Committee', year: 'Session 2026-27', photoUrl: '/team/zaid-mohd.jpg', bio: 'Executive committee member of AIMSA. Contributes to the council teams and helps keep the AI & ML department community active and welcoming.', contributions: JSON.stringify(['Supports council event teams', 'Helps maintain community engagement']), highlightTag: 'TEAM MEMBER', displayOrder: 28 },
  ];
  for (const m of teamMembers) { await prisma.teamMember.upsert({ where: { slug: m.slug }, update: { bio: m.bio, contributions: m.contributions, role: m.role, highlightTag: m.highlightTag }, create: m }); }
