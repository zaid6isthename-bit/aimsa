...
const Hyperspeed = ({ effectOptions = DEFAULT_EFFECT_OPTIONS }: { effectOptions?: any }) => {
  ...
  useEffect(() => {
    ...
    class App {
      options: any; container: any; hasValidSize: boolean; renderer: any; composer: any; camera: any;
      scene: any; fogUniforms: any; clock: any; assets: any; disposed: boolean; road: any;
      leftCarLights: any; rightCarLights: any; leftSticks: any; fovTarget: number; speedUpTarget: number;
      speedUp: number; timeOffset: number; renderPass: any; bloomPass: any;
  ...
  return <div className="hyperspeed-lights" ref={hyperspeed} aria-hidden="true" />;
};
